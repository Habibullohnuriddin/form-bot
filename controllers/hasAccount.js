const {
  whereIsFind_keyboards,
  question_keyboards,
  hasInternet_keyboards,
    ...
    switch (user.step) {
      case 0:
        ...
        return await ctx.replyWithHTML(
          "<strong>1. Ismingizni kiriting</strong>",
          {
            reply_markup: {
      ...
      case 2:
        ...
        return ctx.replyWithHTML(
          "<strong>3. Yoshingizni kiriting</strong> \n\nMasalan: 18"
        );
      case 3:
        if (isNaN(text))
          return ctx.replyWithHTML(
      ...
      case 4:
        ...
        await user.save();
        return ctx.replyWithHTML(
          "<strong>5. Telefon raqamingizni kiriting</strong> \n\nMasalan: +998909888954 yoki 909888954"
        );
      case 5:
        if (/^(?:\+998)?[0-9]{9}$/.test(text)) {
          ...
          return ctx.replyWithHTML(
            "<strong>6. Bizni qayerdan topdingiz?</strong>",
            {
              reply_markup: {
          ...
          return ctx.replyWithHTML(
            `<strong>⚠️ Iltimos telefon raqamingizni quyidagi formatda  kiriting!</strong> \n\n+998909888954 yoki 909888954`
          );
        }
      ...
      case 7:
        ...
        return ctx.replyWithHTML(
          "<strong>8. Kompyuteringiz internetga ulanganmi?</strong>",
          {
            reply_markup: {
      ...
      case 8:
        ...
        return ctx.replyWithHTML(
          "<strong>9. Kompyuteringizda <u>Word</u>, <u>Exel</u> va <u>Telegram</u> bormi?</strong>",
          {
            reply_markup: {
              keyboard: question_keyboards,
              resize_keyboard: true,
